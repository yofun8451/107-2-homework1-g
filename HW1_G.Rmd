...
如果想瞭解是學生本身「能力」或是「學習態度」的問題，可以在加入「入學成績」來做比較回歸分析，但是站在教學的立場不可能將學生表現的不好一切歸咎在他的「能力」不好或是「學習態度」不佳，而是應該瞭解問題後幫忙解決，如果是前者，也許學校可以將那些學生多開個輔導課程或是老師在課程教育上多一點關心及輔導，如果是「學習態度」的問題，那可能需要非課業上的輔導以及全校師生的努力，畢竟整個學校的學習環境和讀書風氣需要大家一起去營造。
